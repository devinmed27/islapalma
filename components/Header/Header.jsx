  ...
  return (
    <header className={s.atomcontainerheader}>
      ...
      <div className={s.bottomContent}>
        <Link href="/rooms">
          <a className={path.includes("rooms") ? s.selected : s.noSelected}>
            HABITACIONES
          </a>
        </Link>
        ...
        <Link href="/experiences">
          <a
            className={path.includes("experiences") ? s.selected : s.noSelected}
          >
            EXPERIENCIAS
          </a>
        </Link>
        ...
        <Link href="/promos">
          <a className={path.includes("promos") ? s.selected : s.noSelected}>
            PLANES
          </a>
        </Link>
        ...
        <Link href="/location">
          <a className={path.includes("location") ? s.selected : s.noSelected}>
            ¿CÓMO LLEGAR?
          </a>
        </Link>
      </div>
