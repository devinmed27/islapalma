...
<div className={s.container}>
    ...
    <div className={s.info}>
        ...
        <p>Tenemos especial interés en proteger y respetar su información y datos personales y por ello hemos diseñado
            estas políticas de tratamiento de la información, dentro del marco de la ley 1581 de 2012 y el decreto
            reglamentario 1377 de 2.013.
            <br />
            <br />
        <h4>1.1 - Introducción.</h4>
        <br />
        Logística HOTEL ISLA PALMA RESERVA NATURAL y las sociedades adscritas, operadoras de los hoteles “una
        experiencia GHL” y responsables del tratamiento de la información, podrán recolectar datos personales de sus
        usuarios, huéspedes o visitantes, a través de los distintos medios destinados para el acceso a los servicios
        prestados por éstos. En todo caso, la recolección se hará bajo expresa autorización del titular de los datos y
        el tratamiento de estos estará sujeto a lo establecido por la ley.
        <br />
        <br />
        La información personal objeto de las consideraciones acá establecidas, podrá ser recolectada directamente de la
        información suministrada y contenida en la tarjeta de registro hotelero, a través de la página web
        www.hotelislapalma.com, mediante la visita o la adquisición de servicios ofrecidos en la plataforma, o
        directamente en los hoteles vinculados o asociados a GHL.
        <br />
        <br />
        Se entenderán aceptadas las consideraciones acá establecidas por el Titular de la Información, cuando suscriba
        la Tarjea de Registro Hotelero respecto de la información allí contenida, cuando visite o haga uso de la página
        web www.hotelislapalma.com y/o cuando ingrese datos o información personal a través de las funciones
        establecidas para ello, sin importar cuál sea el fin.
        <br />
        <br />
        <h4>1.2 - Principios generales.</h4><br />
        ...
        transparencia, seguridad, confidencialidad, principio de acceso y de circulación restringida.<br />
        <br />
        <br />
        <h4>1.3 - Definiciones legales.</h4><br /><br />
        ...
        filosóficas, la pertenencia a sindicatos, organizaciones sociales, de derechos humanos o que promueva intereses
        de cualquier partido político o que garanticen los derechos y garantías de partidos políticos de oposición, así
        como los datos relativos a la salud, a la vida sexual, y los datos biométricos.<br />
        <font color="#C0392B ">1.3.7.</font> <strong>- Dato público:</strong> Es el dato que no sea semiprivado, privado
        o sensible. Son considerados datos públicos, entre otros, los datos relativos al estado civil de las personas, a
        su profesión u oficio y a su calidad de comerciante o de servidor público. Por su naturaleza, los datos públicos
        pueden estar contenidos, entre otros, en registros públicos, documentos públicos, gacetas y boletines oficiales
        y sentencias judiciales debidamente ejecutoriadas que no estén sometidas a reserva.<br />
        <font color="#C0392B ">1.3.8.</font> <strong>- Titular:</strong> Persona natural cuyos datos personales sean
        objeto de Tratamiento.<br />
        <font color="#C0392B ">1.3.9.</font> <strong>- Transferencia:</strong> La transferencia de datos tiene lugar
        cuando el Responsable y/o Encargado del Tratamiento de datos personales, ubicado en Colombia, envía la
        información o los datos personales a un receptor, que a su vez es Responsable del Tratamiento y se encuentra
        dentro o fuera del país.<br />
        ...
        <p>Los datos suministrados estarán sujetos a tratamiento autorizado, concedido de manera previa, expresa e
            informada por el Titular de los mismos. Al suministrar sus datos al ingreso del hotel para diligenciar la
            Tarjeta de Registro Hotelero, está autorizando el tratamiento en los términos y condiciones establecidos en
        ...
        <p>
            ...
            desarrollo del Tratamiento y fines por éste perseguidos, recaerá sobre los datos personales que se reciban y
            almacenen con ocasión del diligenciamiento de la Tarjeta de Registro Hotelero, de la información que nos
            suministre nuestros huéspedes, clientes, visitantes y comprenderá toda la información que se suministre o
            proporcione en la visita a la página web www.hotelislapalma.com, así como toda aquella relacionada con los
            servicios o reservas efectuadas, y los datos de alojamiento y hospedaje suministrados física o virtualmente.
            <br />
            <br />
            Sin perjuicio de que en algunos casos se trate de datos públicos, la información recogida y objeto de
            tratamiento será la correspondiente al nombre, número de documento de identificación sea cédula de
            ciudadanía, pasaporte o cualquier otro válido, profesión, nacionalidad, fecha de nacimiento, dirección de
            correo electrónico, preferencias e intereses personales, trabajo o actividad, hábitos de consumo o hábitos
            de viaje. Si se hace una reserva a través de la página web www.hotelislapalma.com, se recogerá la
            información correspondiente a la tarjeta de crédito que se suministre para los efectos de la reserva y
            estadía.
            <br />
            <br />
            ...
            <br />
            <br />
            Los datos y la información obtenidos serán usados en el curso normal de sus actividades comerciales
            únicamente con la finalidad establecida en las presentes políticas de tratamiento de la información, de
            manera que se permita crear una comunicación directa y efectiva con el huésped, cliente o usuario, que
            conduzca a establecer un vínculo más cercano y a consolidar una relación comercial.
            <br />
            <br />

            El tratamiento consiste en el envío de información digital a través de diferentes vías de comunicación, con
            la intención de contactar con el titular para enviarle encuestas de servicios luego de cada estadía que
            permitan la calificación del servicio prestado, y comunicarle las invitaciones, ofertas, promociones,
            portafolio de servicios o información del Hotel o de los hoteles “una experiencia GHL”, sin que en momento
            alguno sus datos sean facilitados, cedidos o entregados a personas distintas o ajenas a los responsables o
            encargados del tratamiento de la información. Adicionalmente, mediante la recolección de datos se busca:
            realizar, procesar, tramitar y/o completar reservas o compra de noches hoteleras u otros servicios; realizar
            estudios internos sobre hábitos de turismo; evaluar la calidad de nuestros servicios; enviar encuestas y
            cuestionarios respecto de los servicios prestados; atender oportunamente sus solicitudes, peticiones o
            necesidades; comunicar invitaciones, ofertas, promociones, e información en general, sobre el portafolio de
            servicios ofrecidos por personas naturales o jurídicas que se vinculan directamente con la operación
            hotelera y específicamente con los servicios prestados.
            <br />
            <br />
            ...
            Al ingresar a la página web www.hotelislapalma.com autoriza que su información y datos sea compartida con
            los prestadores turísticos a los que se refiere y ante quienes se tramiten sus reservas y/o solicitudes.
            <br />
            <br />
            Se asume que toda la información o datos que se suministran o depositan en la Tarjeta de Registro Hotelero o
            a través de la página www.hotelislapalma.com es verdadera, precisa y completa, y podrá ser retirada en
            cualquier momento en el evento en el que se considere nociva o perjudicial para sus intereses o los
            intereses de un tercero.

            <br />
            <br />
            Los datos y en general la información que se recibe cuando ingresa a la página web www.hotelislapalma.com
            puede ser tanto suya como del equipo desde el cual está ingresando. Con el ánimo de optimizar y hacer más
            eficiente su experiencia visitando la página www.hotelislapalma.com, podrán utilizarse cookies y/o web
            beacons, así como podrá obtenerse y almacenarse la información de las páginas de internet visitadas, de su
            dirección IP, del sistema operativo del equipo desde el cual esté ingresando, mediante un proceso de
            reconocimiento y rastreo que permita identificar sus preferencias e identificarlo cuando visite nuevamente
            página y almacenar determinados registros, a partir de su dirección IP. La dirección IP no se asocia ni se
            vincula a su nombre ni a sus datos personales.
            <br />
            <br />
            ...
            <br />
            <br />
            En ningún evento y bajo ninguna circunstancia se tratarán datos considerados como sensibles, ni la
            recolección de datos está orientada a recoger información de carácter sensible.
            <br />
            <br />
            La recolección de datos correspondientes a niños y adolescentes menores de edad, y la autorización
            respectiva, deberá darse siempre a través de su representante legal, previo ejercicio del menor de su
            derecho a ser escuchado. El tratamiento de datos correspondientes a niños y adolescentes deberá responder y
            respetar el interés superior de niños y adolescentes, y sus derechos fundamentales.
            <br />
            <br />
            En el evento en que por algún motivo alguna pregunta pueda conducir a que la respuesta versen sobre datos
            sensibles o datos de niñas, niños y adolescentes, la respuesta a tal pregunta tendrá carácter facultativo.
            <br />
            <br />
            ...
            obligan a: a) Garantizar al Titular, en todo tiempo, el pleno y efectivo ejercicio del derecho de hábeas
            data; b) Solicitar y conservar, en las condiciones previstas en la ley, copia de la respectiva autorización
            otorgada por el Titular; c) Informar debidamente al Titular sobre la finalidad de la recolección y los
            derechos que le asisten por virtud de la autorización otorgada; d) Conservar la información bajo las
            condiciones de seguridad necesarias para impedir su adulteración, pérdida, consulta, uso o acceso no
            autorizado o fraudulento; e) Garantizar que la información que se suministre al Encargado del Tratamiento
            sea veraz, completa, exacta, actualizada, comprobable y comprensible; f) Actualizar la información,
            comunicando de forma oportuna al Encargado del Tratamiento, todas las novedades respecto de los datos que
            previamente le haya suministrado y adoptar las demás medidas necesarias para que la información suministrada
            a este se mantenga actualizada; g) Rectificar la información cuando sea incorrecta y comunicar lo pertinente
            al Encargado del Tratamiento; h) Suministrar al Encargado del Tratamiento, según el caso, únicamente datos
            cuyo Tratamiento esté previamente autorizado de conformidad con lo previsto en la presente ley; i) Exigir al
            Encargado del Tratamiento en todo momento, el respeto a las condiciones de seguridad y privacidad de la
            información del Titular; j) Tramitar las consultas y reclamos formulados en los términos señalados en la
            ley; k) Informar al Encargado del Tratamiento cuándo determinada información se encuentra en discusión por
            parte del Titular, una vez se haya presentado la reclamación y no haya finalizado el trámite respectivo; l)
            Informar a solicitud del Titular sobre el uso dado a sus datos; m) Informar a la autoridad de protección de
            datos cuando se presenten violaciones a los códigos de seguridad y existan riesgos en la Administración de
            la información de los Titulares. n) Cumplir las instrucciones y requerimientos que imparta la
        ...
        <p>
            ...
            <br />
            <br />
            Una vez otorgada la autorización por parte del Titular para el tratamiento correspondiente, éste tiene
            derecho a: a) Conocer, actualizar y rectificar sus datos personales. Este derecho se podrá ejercer frente a
            datos parciales, inexactos, incompletos, fraccionados, que induzcan a error, o aquellos cuyo Tratamiento
            esté expresamente prohibido o no haya sido autorizado; b) Solicitar prueba de la autorización otorgada,
            salvo cuando expresamente se exceptúa como requisito para el Tratamiento, de conformidad con lo previsto en
            el artículo 10 de la ley 1581 de 2012; c) Ser informado por el responsable y/o encargado de los datos
            personales, previa solicitud, del uso que se le ha dado a sus datos personales; d) Presentar ante la
            Superintendencia de Industria y Comercio quejas por infracciones a lo dispuesto en la ley; e) Revocar la
            ...
            Superintendencia de Industria y Comercio haya determinado que en el Tratamiento se ha incurrió en conductas
            contrarias a esta ley y a la Constitución; f) Solicitar, en todo momento al responsable o encargado, la
            supresión de sus datos personales y/o revocar la autorización otorgada para el Tratamiento de los mismos,
            mediante la presen­tación de un reclamo, no procederán cuando el Titular tenga un deber legal o contractual
            de permanecer en la base de datos. g) Acceder en forma gratuita a sus datos personales que hayan sido objeto
            de Tratamiento: (i) al menos una vez cada mes calendario, y (ii) cada vez que existan modificaciones
            sustanciales de las Políticas de Tratamiento de la información que motiven nuevas consultas. En caso de
            solicitudes cuya periodicidad sea mayor a una por cada mes calendario, el responsable y/o encargado, podrá
            ...
            estipulación a favor de otro o para otro; e). Los derechos de los niños, niñas o adolescentes se ejercerán
            por las personas que estén facultadas para representarlos, previa acreditación de la facultad de
            representación.
            <br />
            <br />
            ...
            <br />
            <br />
            <font color="#C0392B ">4.4.1</font>- El reclamo se formulará mediante solicitud dirigida al Responsable del
            Tratamiento o al Encargado del Tratamiento, con la identificación del Titular, la descripción de los hechos
            que dan lugar al reclamo y la dirección, acompañando los documentos que se quiera hacer valer. Si el reclamo
            resulta incompleto, se requerirá al interesado dentro de los cinco (5) días hábiles siguientes a la
            ...
            <br />
            <br />
            <font color="#C0392B ">4.4.3.</font><strong>Consulta y acceso a la información.</strong>
            <br />
            <br />
            Las consultas de datos personales se atenderán mediante solicitud escrita a través del correo electrónico
            info@hotelislapalma.com.
            <br />
            <br />
            Las consultas serán atendidas en un término máximo de diez (10) días hábiles contados a partir de la fecha
            de su recibo. Cuando no fuere posible atender la consulta dentro de dicho término, se informará al
            interesado antes del vencimiento de diez (10) días hábiles, expresando los motivos de la demora y señalando
            la fecha en que se atenderá la consulta, la cual en ningún caso podrá superar los cinco (5) días hábiles
        ...
        facilitados, cedidos o entregados a personas distintas o ajenas a los responsables o encargados del tratamiento.
        <br />
        <br />
        <font color="#C0392B ">5.2</font> <strong>.- Transferencia y transmisión de datos.</strong>
        <br />
        <br />
        En el evento en que se suscriba un contrato con una tercera persona profesional y con experiencia en el manejo y
        uso de bases de datos, el responsable suscribirá el contrato de transmisión de datos personales al que se
        refiere el artículo 25 del decreto 1377 de 2013.
        ...
        <p>
            ...
            <br />
            <br />
            El presente documento, mediante el cual se establecen las políticas de tratamiento de la información sobre
            datos personales recolectados estará publicado de manera permanente en el vínculo www.hotelislapalma.com
            para que pueda ser consultado por quien esté interesado.
            <br />
            <br />
            ...
            <br />
            <br />
            <strong>El presente documento entra en vigencia el 22 dde febrero de 2016.</strong>
            ...
            <br />
            <br />
            <font color="#17202A"> HOTEL ISLA PALMA RESERVA NATURAL</font>, con NIT 900 648506-1 tiene la calidad de
            responsable y encargado del tratamiento de datos personales. Las sociedades serán responsables de la
            información y de los datos personales recolectados. Cuando la información haya sido recibida o recolectada
            por alguna de las sociedades anotadas, con expresa autorización para ser transferida,HOTEL ISLA PALMA
            RESERVA NATURAL será responsable del tratamiento.
            <br />
            <br />
            ...
            <br />
            <center>
                <h3>POLITICAS DE TRATAMIENTO DE LA INFORMACIÓN PERSONAL PROVEEDORES</h3>
            </center>
        ...
        <br />
        <br />
        Logística HOTEL ISLA PALMA RESERVA NATURAL y las sociedades adscritas, operadoras de los hoteles una experiencia
        GHL y responsables del tratamiento de la información, podrán recolectar datos personales de sus proveedores, y
        en general de quien les venda bienes o servicios, en desarrollo de la relación comercial para facilitar su
        ejecución y procurar la mayor eficiencia posible. La recolección se hará bajo expresa autorización del titular
        de los datos y el tratamiento de estos estará sujeto a lo establecido por la ley y la presente política.
        <br />
        <br />
        La información personal podrá ser recolectada directamente de los proveedores o a partir de aquella información
        contenida en el certificado de existencia y representación legal expedido por la Cámara de Comercio, en el RUT,
        ...
        <p>
            ...
            <br />
            <br />
            <strong>El presente documento entra en vigencia el 22 de febrero de 2016.</strong>
            <br />
            <br />
            <font color="#C0392B ">6.3.</font> <strong>- Procedimiento para los eventos de modificación de las
                políticas.</strong>
        ...
        <br />
        Logística HOTEL ISLA PALMA RESERVA NATURAL y las sociedades adscritas operadoras de los hoteles “una experiencia
        GHL” y responsables del tratamiento de la información, podrán recolectar datos personales de sus empleados,
        funcionarios y/o colaboradores, con independencia del vínculo y naturaleza contractual. La recolección se hará
        bajo expresa autorización del titular de los datos y el tratamiento de estos estará sujeto a lo establecido por
        la ley y la presente política.
        <br />
        <br />
        La información personal será recolectada directamente de los empleados, funcionarios y/o colaboradores y estará
        relacionada con la actividad que desarrollen.
        <br />
        <br />
        <font color="#C0392B ">1.2</font><strong>- Principios generales.</strong>
        ...
        <p>
            Los datos suministrados estarán sujetos a tratamiento autorizado, concedido de manera previa, expresa e
            informada por el Titular de los mismos, en todo caso, la recolección de datos estará limitada a aquellos
            datos personales que sean pertinentes y adecuados para la finalidad perseguida.
            <br />
            <br />
        </p>
        <h3> TERCERO: TRATAMIENTO DE LA INFORMACIÓN:</h3>
        <p>
            ...
            <br />
            Sin perjuicio de que en algunos casos se trate de datos públicos, la información recogida y objeto de
            tratamiento será la correspondiente a la suministrada en la hoja de vida, nombre, número de cédula de
            ciudadanía o pasaporte, experiencia académica, experiencia profesional, información relacionada con la
            ...
            <br />
            El tratamiento que se dará a los datos consiste en el manejo y disposición de los datos para contar con la
            información que permita adelantar las actividades, procesos y procedimientos de talento humano; para
            establecer el estado de pago de nómina; honorarios o cualquier otra remuneración, según el caso; para
            gestionar la información correspondiente a la seguridad social y a las cajas de compensación familiar; para
            atender los requerimientos de información de entidades gubernamentales y cumplir con las obligaciones
            legales de reportes en materia fiscal, tributaria y de cualquier otra naturaleza; soportar procesos de
 ...
 <h3>CUARTO: DERECHOS Y FACULTADES DEL TITULAR:</h3>
        <p>
            <font color="#C0392B "> 4.1.</font><strong>- Derechos del titular. Una vez otorgada la autorización por
                parte del Titular para el tratamiento correspondiente, éste tiene derecho a:</strong> <br />
                <font color="#C0392B ">a)</font> Conocer, actualizar y
                rectificar sus datos personales. Este derecho se podrá ejercer frente a datos parciales, inexactos,
                incompletos, fraccionados, que induzcan a error, o aquellos cuyo Tratamiento esté expresamente prohibido
                o no haya sido autorizado;<br /> 
                <font color="#C0392B "> b)</font> Solicitar prueba de la autorización otorgada, salvo cuando expresamente se
                exceptúe como requisito para el Tratamiento, de conformidad con lo previsto en el artículo 10 de la ley
                1581 de 2012; <br />
                <font color="#C0392B ">c)</font> Ser informado por el responsable y/o encargado de los datos personales, previa
                solicitud, del uso que se le ha dado a sus datos personales; <br />
                <font color="#C0392B ">d)</font> Presentar ante la Superintendencia de
                Industria y Comercio quejas por infracciones a lo dispuesto en la ley; <br />
               <font color="#C0392B "> e)</font> Revocar la autorización y/o solicitar la supresión del dato cuando en el Tratamiento no se respeten los principios, derechos y
                garantías constitucionales y legales. La revocatoria y/o supresión procederá cuando la Superintendencia
                de Industria y Comercio haya determinado que en el Tratamiento se ha incurrió en conductas contrarias a
                esta ley y a la Constitución; <br />
               <font color="#C0392B "> f)</font> Solicitar, en todo momento al responsable o encargado, la supresión de sus datos personales y/o revocar la autorización otorgada para el Tratamiento de los mismos, mediante la
                presentación de un reclamo, no procederán cuando el Titular tenga un deber legal o contractual de
                permanecer en la base de datos. <br />
                <font color="#C0392B ">g)</font> Acceder en forma gratuita a sus datos personales que hayan sido
                objeto de Tratamiento: (i) al menos una vez cada mes calendario, y (ii) cada vez que existan
                modificaciones sustanciales de las Políticas de Tratamiento de la información que motiven nuevas
                consultas. En caso de solicitudes cuya periodicidad sea mayor a una por cada mes calendario, el
                responsable y/o encargado, podrá cobrar al Titular los gastos de envío, reproducción y, en su caso,
            ...
            <br />
            <br />
            <font color="#C0392B "> 4.5.</font>- Consulta y acceso a la información.
            <br />
            <br />
            Las consultas de datos personales contenidos en la base de datos se atenderán mediante solicitud escrita a
            través del correo electrónico info@hotelislapalma.com.
            <br />
            <br />
            Las consultas serán atendidas en un término máximo de diez (10) días hábiles contados a partir de la fecha
            de su recibo. Cuando no fuere posible atender la consulta dentro de dicho término, se informará al
